...
function redirectTrackWaterConsumptionPage() {
    ...
    location.href = "track-water-consumption.php?date=" + dateInput.value;
}
...
function previousDate() {
    ...
    location.href = "track-water-consumption.php?date=" + date.getFullYear() + "-" + (date.getMonth() +  1)+ "-" + date.getDate();
}
