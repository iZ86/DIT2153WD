...
<section class="px-20 py-5 bg-blue-100">
    <h1 class="text-2xl font-bold ml-24 mb-11">Monthly Membership</h1>
    <!--Main Flex Container-->
    <div class="flex text-center space-x-14 max-w-5xl mx-auto text-xl w-full">
        ...
        <div class="w-1/2 px-6">
            <div class="space-y-12">
                <div>
                    <h2 class="bg-gray-400 text-2xl rounded p-2">Monthly Membership</h2>
                    <h2 class="bg-gray-200 text-2xl font-light rounded p-2">RM 50 per month</h2>
                </div>
                <div class="bg-gray-200 rounded outline-black border-2 border-black">
                    <!--Classes Header-->
                    <h2 class="bg-orange-500 text-3xl rounded py-5 w-full">Classes</h2>

                    <!--Class Labels Container-->
                    <div class="p-6 font-semibold text-2xl">
                        <label class="flex items-center justify-between bg-gray-400 px-11 py-4 rounded mb-5">
        ...
        <div class="w-1/2">
            <h2 class="bg-gray-400 text-2xl rounded p-2">Class Details</h2>
            <div class="bg-gray-200 px-6 pb-10 rounded-lg">
                <h3 class="bg-gray-200 rounded p-2 text-">Pilates Class</h3>
                ...
                <button class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600">ADD</button>
            </div>
        </div>
    </div>
</section>
