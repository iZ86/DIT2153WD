        ...
        <div class="flex flex-col items-center bg-blue-vivid w-full rounded-2xl shadow-lg modal-content basis-144 min-h-128">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] . "?date=" . $_GET['date']; ?>" method="POST">
                ...
                <div class="flex justify-center mt-28">
                    ...
                    <input type="submit" id="saveEditWaterConsumptionDataButton" name="saveEditWaterConsumptionDataButton" value="Save" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-6 hidden rounded-lg shadow-lg cursor-pointer">
                </div>
            </form>
        </div>
    </div>
