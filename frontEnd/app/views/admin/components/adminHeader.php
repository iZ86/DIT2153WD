...
<head>
    ...
    <title>Admin Dashboard - Huan Fitness Centre</title>
    <link rel="stylesheet" href=<?php echo '"' . preg_replace("/.+\/DIT2153WD\//", "http://localhost/DIT2153WD/", str_replace('\\', '/', __DIR__)) . "/../../../public/css/output.css" . '"'?>>
