        ...
        <table class="min-w-full table-auto border-collapse w-full">
            ...
            <tbody class="text-gray-700 text-center">
                <tr class="bg-white">
                    ...
                    <td class="p-3 mt-4">This is a yoga class...</td>
                ...
                <tr class="bg-white">
                    ...
                    <td class="p-3">This is a swimming class...</td>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-lg overflow-x-auto" style="height: 600px;">
            <table class="min-w-full table-auto border-collapse w-full">
                ...
                <tr class="bg-white">
                    ...
                    <td class="p-3 mt-4">
                        <span class="bg-purple-100 text-purple-700 text-sm font-medium px-3 py-1 rounded-lg">05 Aug 2024</span>
                    </td>
                    <td class="p-3 mt-4">
                        <span class="bg-orange-100 text-orange-700 text-sm font-medium px-3 py-1 rounded-lg">01 Aug 2024</span>
                    </td>
                    <td class="p-3  mt-4 flex justify-center space-x-2">
                        <button class="text-gray-500 hover:text-blue-600">
                            <i class="bx bx-pencil"></i>
                ...
                <tr class="bg-white">
                    ...
                    <td class="p-3 mt-4">
                        <span class="bg-orange-100 text-orange-700 text-sm font-medium px-3 py-1 rounded-lg">30 Sep 2024</span>
                    </td>
                    <td class="p-3 flex justify-center space-x-2">
                        <button class="text-gray-500 hover:text-blue-600">
                            <i class="bx bx-pencil"></i>
