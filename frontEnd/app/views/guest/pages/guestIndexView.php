...
<section class="p-6 space-y-6 bg-indigo-50">
    ...
    <div class="bg-white p-6 rounded-3xl shadow-lg overflow-x-auto mx-auto flex flex-col items-center" style="width:1300px">
        ...
        <div class="font-medium text-center p-6 mt-4">
            ...
            <input type="button" value="Join Us Today!" class="bg-orange-400 hover:bg-orange-500 text-white text-sm font-medium py-2 px-2 rounded-full flex items-center space-x-2 w-40 mx-auto mt-4">
        </div>
    </div>
</section>
